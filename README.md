  ...
  <body>
    ...
    <div id="sidebar">
      <div id="sponsor">
        ...
        <div class="sponsor">
          <a
            href="https://tretton37.com/join"
            target="_blank"
            onclick="if(ga)ga('send','event','sponsor','sidebar',this.href);"
            rel="noopener"
            >tretton37</a
          >
          - Means 1337 in Swedish. What you see is who we are!
        </div>
      </div>
    </div>
    <!--/sidebar-->
    ...
    <main>
      <article>
        <p>
          ...
          <a href="/2019/about">about page</a>, or you can ask for hints on the
          <a href="https://www.reddit.com/r/adventofcode/" target="_blank"
            >subreddit</a
          >. Please wait one minute before trying again. (You guessed
          <span style="white-space:nowrap;"><code>9</code>.)</span>
          <a href="/2019/day/2">[Return to Day 2]</a>
        </p>
      </article>
    </main>
